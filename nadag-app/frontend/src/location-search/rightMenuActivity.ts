				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement("input", {
							...
							className:
								"rounded border border-neutral-300 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-brand-primary",
						}),
						React.createElement(
							"button",
							{
								...
								className:
									"rounded bg-brand-primary px-3 py-2 text-sm font-medium text-white disabled:cursor-not-allowed disabled:opacity-60",
							},
					...
					isSelecting
						? React.createElement(
								...
								"Zooming to selected result...",
							)
						: null,
					error
						? React.createElement(
								"p",
								{ className: "text-sm text-red-700", role: "alert" },
								error,
							)
						: null,
					React.createElement(
						...
						results.map((featureCollection, index) =>
							React.createElement(
								"section",
								{
									...
									className:
										"flex flex-col gap-2 rounded border border-neutral-200 bg-white p-3",
								},
								React.createElement(
									"p",
									...
									(featureCollection.features || []).map((feature, featureIndex) =>
										React.createElement(
											"button",
											{
												...
												type: "button",
												onClick: () =>
													void onSelectFeature(feature),
												disabled: isSelecting || !feature.geometry,
												className:
													"w-full rounded border border-neutral-200 bg-neutral-50 p-2 text-left text-xs disabled:cursor-not-allowed disabled:opacity-60",
											},
