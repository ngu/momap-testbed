            ...
            <plugin>
                ...
                <executions>
                    <execution>
                        ...
                        <configuration>
                            <outputDirectory>${project.build.outputDirectory}/frontend-extensions/sample</outputDirectory>
                            <resources>
                                <resource>
...
```
            ...
            <plugin>
                ...
                <configuration>
                    <archive>
                        <manifest>
                            <mainClass>imr.hi.sampleapp.AppLauncherKt</mainClass>
...
COPY /target/sample-app-0.0.1-SNAPSHOT.jar ./
